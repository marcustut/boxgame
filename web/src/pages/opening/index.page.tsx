...
// const video = document.getElementById('logo-video') as HTMLVideoElement
...
export const WaveShaderMaterial = shaderMaterial(
  // Uniform
  {
    ...
    // uVideoTexture: new THREE.VideoTexture(video)
  },
  // Vertex Shader
  glsl`
  //	Simplex 3D Noise 
...
const Wave = () => {
  const ref = useRef<{ [uniform: string]: THREE.IUniform<unknown> | number }>(null)
...
const OpeningPage: React.FC = () => {
  ...
  return (
    <div className='h-[100vh] bg-dark-800'>
      <Scene />
    </div>
  )
}
